...
@property (strong, nonatomic) NSURLConnection *uconnection;
...
@property (weak, nonatomic) id<MCCURLConnectionContextProtocol> context; // Weak reference to the context. You must retain the context.
