...
@property (strong, nonatomic) id userInfo; // You may set any objective-c object as userInfo
@property (strong, nonatomic) NSString *identifier; // Use this to provide a custom identifier for unique request enforcement. The default identifier is @"<HTTP_METHOD> <URL>"
